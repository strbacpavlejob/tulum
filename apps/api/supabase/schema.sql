...
CREATE OR REPLACE FUNCTION "public"."get_engagement_chart_data"("p_venue_ids" uuid[], "p_event_id" uuid DEFAULT NULL::uuid) RETURNS TABLE("date" "date", "views" bigint, "bookmarks" bigint, "attended" bigint)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_engagement_chart_data"("p_venue_ids" uuid[], "p_event_id" uuid) OWNER TO "postgres";


COMMENT ON FUNCTION "public"."get_engagement_chart_data"("p_venue_ids" uuid[], "p_event_id" uuid) IS 'Returns engagement metrics (views, bookmarks, attended) aggregated by date for the last 90 days. 
...
COMMENT ON TABLE "public"."venue_contacts" IS 'Contact information for venue reservations (phone/viber/whatsapp/sms/instagram)';
...
ALTER TABLE ONLY "public"."venues"
    ADD CONSTRAINT "venues_contact_id_fkey" FOREIGN KEY ("contact_id") REFERENCES "public"."venue_contacts"("id") ON DELETE SET NULL;
