  ...
  ),
  {
    variants: {
      variant: {
        ...
        filled: cn(
          "border-border bg-background active:bg-accent dark:bg-white dark:border-input dark:active:bg-input/50 border shadow-sm shadow-black/5",
          Platform.select({
            web: "hover:bg-accent dark:hover:bg-input/50",
          }),
        ),
      ...
      size: {
        default: cn(
          "h-10 px-4 py-2 rounded-full sm:h-9",
          Platform.select({
            web: "has-[>svg]:px-3",
          }),
        ),
