...
export default function PricingGuest() {
  ...
  const pricingPlans = [
    {
      name: t("landingpage.guestPricing.free.name"),
      monthlyPrice: 0,
      yearlyPrice: 0,
      isFree: true,
      ...
      cta: t("landingpage.guestPricing.getStarted"),
      popular: false,
    },
    {
      name: t("landingpage.guestPricing.premium.name"),
      monthlyPrice: 9,
      yearlyPrice: 86,
      isFree: false,
  ...
  return (
    ...
    >
      <div className="border-b w-full h-full p-10 md:p-14">
        <div className="max-w-xl mx-auto flex flex-col items-center justify-center gap-2">
          <h2 className="text-3xl md:text-4xl font-medium tracking-tighter text-center text-balance">
            {t("landingpage.guestPricing.title")}
          </h2>
          <p className="text-muted-foreground text-center text-balance font-medium">
            {t("landingpage.guestPricing.subtitle")}
          </p>
        </div>
      </div>
      ...
      <div className="relative w-full h-full">
        <div className="absolute -top-14 left-1/2 -translate-x-1/2">
          <div className="relative flex w-fit items-center rounded-full border p-0.5 backdrop-blur-sm cursor-pointer h-9 flex-row bg-muted mx-auto">
            ...
            >
              ...
              >
                {t("landingpage.guestPricing.monthly")}
              </span>
            </button>
            <button
        ...
        <div className="grid min-[650px]:grid-cols-2 gap-4 w-full max-w-3xl mx-auto px-6 items-stretch">
            ...
            >
              ...
              <div className="flex flex-col gap-4 p-4">
                ...
                <div className="flex items-baseline mt-2">
                  ...
                  {!plan.isFree && (
                    <span className="ml-2">
                      /{t("landingpage.guestPricing.perMonth")}
                    </span>
                  )}
                </div>
                {/* {plan.popular && (
